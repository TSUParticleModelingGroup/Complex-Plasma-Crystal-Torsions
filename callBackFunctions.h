...
void KeyPressed(unsigned char key, int x, int y)
{
	...
	if(key == '2')
	{
		...
		DustPositionCPU[3].y = 0.0;
		DustPositionCPU[3].z = -RadialConfinementScale;
		
		DustPositionCPU[4].x = 0.0;
		DustPositionCPU[4].y = 0.0;
		DustPositionCPU[4].z = RadialConfinementScale;
